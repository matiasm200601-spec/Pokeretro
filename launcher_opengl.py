...
class Launcher:
    def __init__(self, root):
        ...
        self.root.title("PokeRetro Launcher - OpenGL")
        ...
        bg_path = os.path.join(get_launcher_dir(), "fondolauncher.jpg")
        ...
        # Subtítulo OpenGL
        self.canvas.create_text(WINDOW_W // 2 + 1, 101, text="OpenGL", anchor="center", font=("Arial", 11, "bold"), fill="#000000")
        self.canvas.create_text(WINDOW_W // 2, 100, text="OpenGL", anchor="center", font=("Arial", 11, "bold"), fill="#FFD700")
    ...
    def run_update(self):
        ...
        try:
            ...
            self.set_status(f"Sin conexión. Iniciando de todas formas...")
        ...
        for rel_path, remote_md5 in files.items():
            ...
            if not os.path.exists(local_path) or md5_file(local_path) != remote_md5:
