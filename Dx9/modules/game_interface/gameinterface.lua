...
function bindKeys()
  ...
  g_keyboard.bindKeyDown('W', function() if modules.client_options.getOption('wasdMovement') then changeWalkDir(North) end end, gameRootPanel, true)
  g_keyboard.bindKeyDown('D', function() if modules.client_options.getOption('wasdMovement') then changeWalkDir(East) end end, gameRootPanel, true)
  g_keyboard.bindKeyDown('S', function() if modules.client_options.getOption('wasdMovement') then changeWalkDir(South) end end, gameRootPanel, true)
  g_keyboard.bindKeyDown('A', function() if modules.client_options.getOption('wasdMovement') then changeWalkDir(West) end end, gameRootPanel, true)
  ...
  g_keyboard.bindKeyUp('W', function() changeWalkDir(North, true) end, gameRootPanel, true)
  g_keyboard.bindKeyUp('D', function() changeWalkDir(East, true) end, gameRootPanel, true)
  g_keyboard.bindKeyUp('S', function() changeWalkDir(South, true) end, gameRootPanel, true)
  g_keyboard.bindKeyUp('A', function() changeWalkDir(West, true) end, gameRootPanel, true)
  ...
  g_keyboard.bindKeyPress('W', function() if modules.client_options.getOption('wasdMovement') then smartWalk(North) end end, gameRootPanel)
  g_keyboard.bindKeyPress('D', function() if modules.client_options.getOption('wasdMovement') then smartWalk(East) end end, gameRootPanel)
  g_keyboard.bindKeyPress('S', function() if modules.client_options.getOption('wasdMovement') then smartWalk(South) end end, gameRootPanel)
  g_keyboard.bindKeyPress('A', function() if modules.client_options.getOption('wasdMovement') then smartWalk(West) end end, gameRootPanel)
  ...
  g_keyboard.bindKeyDown('Ctrl+W', function() g_game.turn(North) end, gameRootPanel)
  g_keyboard.bindKeyDown('Ctrl+S', function() g_game.turn(South) end, gameRootPanel)
  g_keyboard.bindKeyDown('Ctrl+D', function() g_game.turn(East) end, gameRootPanel)
  g_keyboard.bindKeyDown('Ctrl+A', function() g_game.turn(West) end, gameRootPanel)
  g_keyboard.bindKeyDown('Ctrl+Shift+W', function() g_map.cleanTexts() modules.game_textmessage.clearMessages() end, gameRootPanel)
